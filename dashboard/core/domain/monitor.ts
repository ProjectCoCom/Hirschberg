/**
 * Summary: Domain model definitions for 'Monitor'.
 *
 * What it does: Defines TypeScript interfaces, validation types, and helper algorithms for 'Monitor' model states.
 *
