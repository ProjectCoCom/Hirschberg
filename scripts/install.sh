#!/usr/bin/env bash
# Summary: Unix setup and installation shell script.
#
# What it does: Installs python requirements and configures NPM/PNPM frontend packages.
#
# How it fits in: Main environment setup script.
