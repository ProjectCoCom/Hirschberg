"""
Summary: JDOCS prompt template manager.

What it does: Compiles XML structures and manages prompt templates for agent context, rules, and history.

How it fits in: Utilized by 'src/core/prompt_builder.py'.
"""
