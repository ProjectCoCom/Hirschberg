"""
Summary: Text and context compressor helper.

What it does: Compresses excessive token streams and long histories to keep agent contexts within model limits.

How it fits in: Assists prompt construction.
"""
