...
class Database:
    ...
    def select_sync(
        ...
        columns: str | None = None, order_by: str | None = None,
        limit: int | None = None
    ) -> list[dict]:
    ...
    async def delete(
        self, table: str, filters: dict[str, Any] | str | None = None
    ) -> bool:
        return await self._local.delete(table, filters)

    def subscribe(
        self, table: str, event_type: str, callback: Callable[[dict], None],
